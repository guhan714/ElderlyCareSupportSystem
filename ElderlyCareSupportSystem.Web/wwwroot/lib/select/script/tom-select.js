...
!function (e, t) {
    ...
    const f = new RegExp(Object.keys(h).join("|") + "|[̀-ͯ·ʾʼ]", "gu"), m = (e, t = "NFKD") => e.normalize(t),
        ...
        y = e => (e = m(e).toLowerCase().replace(f, e => h[e] || ""), m(e, "NFC"))
    const b = e => {
        const t = {}, s = (e, s) => {
        ...
        for (let t of function* (e) {
            for (const [t, s] of e) for (let e = t; e <= s; e++) {
                ...
                s != t.toLowerCase() && (s.length > 3 || 0 != s.length && (yield{
                    folded: s,
                    composed: t,
                    code_point: e
                }))
    ...
    class C {
        ...
        clone(e, t) {
            let s = new C, i = JSON.parse(JSON.stringify(this.parts)), n = i.pop()
    ...
    class T {
        ...
        tokenize(e, t, s) {
            ...
            return s && (o = new RegExp("^(" + Object.keys(s).map(r).join("|") + "):(.*)$")), n.forEach(e => {
                let s, n = null, l = null
                o && (s = e.match(o)) && (n = s[1], e = s[2]), e.length > 0 && (l = this.settings.diacritics ? A(e) || null : r(e), l && t && (l = "\\b" + l)), i.push({
                    string: e,
        ...
        _getScoreFunction(e) {
            ...
            const l = 1 === o ? function (e, t) {
                const s = i[0].field
                return k(r(t, s), e, n[s] || 1)
            } : function (e, t) {
                var s = 0
                if (e.field) {
                    const i = r(t, e.field)
                    !e.regex && i ? s += 1 / o : s += k(i, e, 1)
                } else L(n, (i, n) => {
                    s += k(r(t, n), e, i)
                })
                return s / o
            ...
            if (F(i, "sort"), F(i, "sort_empty"), i.fields) {
                ...
                i.fields.forEach(t => {
                    "string" == typeof t && (t = {
                        field: t,
                        weight: 1
                    }), e.push(t), s[t.field] = "weight" in t ? t.weight : 1
                }), i.fields = e
            }
            return {
                options: i,
    ...
    const P = e => null == e ? null : N(e), N = e => "boolean" == typeof e ? e ? "1" : "0" : e + "",
        ...
        $ = (e, t) => {
            ...
            return function (i, n) {
                var o = this
                s && (o.loading = Math.max(o.loading - 1, 0), clearTimeout(s)), s = setTimeout(function () {
    ...
    function le(e, t) {
        var s = Object.assign({}, re, t), i = s.dataAttr, n = s.labelField, o = s.valueField, r = s.disabledField,
            l = s.optgroupField, a = s.optgroupLabelField, c = s.optgroupValueField, d = e.tagName.toLowerCase(),
        ...
        return "select" === d ? (() => {
            ...
            p.maxItems = e.hasAttribute("multiple") ? null : 1, B(e.children, e => {
                var s, i, n
                "optgroup" === (t = e.tagName.toLowerCase()) ? ((n = f(s = e))[a] = n[a] || s.getAttribute("label") || "", n[c] = n[c] || h++, n[r] = n[r] || s.disabled, n.$order = n.$order || ++g, p.optgroups.push(n), i = n[c], B(s.children, e => {
                    m(e, i)
                })) : "option" === t && m(e)
            })
        })() : (() => {
    ...
    class ce extends (function (e) {
        ...
        constructor(e, t) {
            ...
            var p
            if (W(r, n.wrapperClass, d, u), W(l, n.controlClass), z(r, l), W(a, n.dropdownClass, u), n.copyClassesToDropdown && W(a, d), W(c, n.dropdownContentClass), z(a, c), K(n.dropdownParent || r).appendChild(a), Q(n.controlInput)) {
                p = K(n.controlInput)
        ...
        setup() {
            const e = this, t = e.settings, s = e.control_input, i = e.dropdown, n = e.dropdown_content, o = e.wrapper,
            ...
            (null === t.maxItems || t.maxItems > 1) && e.is_select_tag && se(a, {multiple: "multiple"}), t.placeholder && se(s, {placeholder: t.placeholder}), !t.splitOn && t.delimiter && (t.splitOn = new RegExp("\\s*" + r(t.delimiter) + "+\\s*")), t.load && t.loadThrottle && (t.load = $(t.load, t.loadThrottle)), D(i, "mousemove", () => {
                e.ignoreHover = !1
            }), D(i, "mouseenter", t => {
            ...
            D(a, "invalid", y), D(document, "mousedown", m), D(window, "scroll", v, d), D(window, "resize", v, d), this._destroy = () => {
                a.removeEventListener("invalid", y), document.removeEventListener("mousedown", m), window.removeEventListener("scroll", v), window.removeEventListener("resize", v), g && g.removeEventListener("click", f)
            }, this.revertSettings = {
                innerHTML: a.innerHTML,
                tabIndex: a.tabIndex
            }, a.tabIndex = -1, a.insertAdjacentElement("afterend", e.wrapper), e.sync(!1), t.items = [], delete t.optgroups, delete t.options, e.refreshItems(), e.close(!1), e.inputState(), e.isSetup = !0, a.disabled ? e.disable() : a.readOnly ? e.setReadOnly(!0) : e.enable(), e.on("change", this.onChange), W(a, "tomselected", "ts-hidden-accessible"), e.trigger("initialize"), !0 === t.preload && e.preload()
        }
        ...
        onKeyDown(e) {
            ...
            if (t.ignoreHover = !0, t.isLocked) 9 !== e.keyCode && q(e)
                ...
                switch (e.keyCode) {
                    case 65:
                        if (R(oe, e) && "" == t.control_input.value) return q(e), void t.selectAll()
                        break
                    case 27:
                    ...
                    case 38:
                        ...
                        return void q(e)
                    case 13:
                        return void (t.canSelect(t.activeOption) ? (t.onOptionSelect(e, t.activeOption), q(e)) : (t.settings.create && t.createItem() || document.activeElement == t.control_input && t.isOpen) && q(e))
                    case 37:
                        return void t.advanceSelection(-1, e)
                    case 39:
                        return void t.advanceSelection(1, e)
                    case 9:
                        return void (t.settings.selectOnTab && (t.canSelect(t.activeOption) ? (t.onOptionSelect(e, t.activeOption), q(e)) : t.settings.create && t.createItem() && q(e)))
                    case 8:
                    case 46:
                        return void t.deleteSelection(e)
                }
                t.isInputHidden && !R(oe, e) && q(e)
            }
        }
        ...
        onOptionSelect(e, t) {
            var s, i = this
            t.parentElement && t.parentElement.matches("[data-disabled]") || (t.classList.contains("create") ? i.createItem(null, () => {
                i.settings.closeAfterSelect ? i.close() : i.settings.clearAfterSelect && i.setTextboxValue()
            }) : void 0 !== (s = t.dataset.value) && (i.lastQuery = null, i.addItem(s), i.settings.closeAfterSelect ? i.close() : i.settings.clearAfterSelect && i.setTextboxValue(), !i.settings.hideSelected && e.type && /click/.test(e.type) && i.setActiveOption(t)))
        }
        ...
        loadCallback(e, t) {
            const s = this
            s.loading = Math.max(s.loading - 1, 0), s.lastQuery = null, s.clearActiveOption(), s.setupOptions(e, t), s.refreshOptions(s.isFocused && !s.isInputHidden), s.loading || J(s.wrapper, s.settings.loadingClass), s.trigger("load", e, t)
        }
        ...
        setActiveItem(e, t) {
            ...
            if ("single" !== a.settings.mode) {
                ...
                if ("click" === (s = t && t.type.toLowerCase()) && R("shiftKey", t) && a.activeItems.length) {
                    ...
                    q(t)
                } else "click" === s && R(oe, t) || "keydown" === s && R("shiftKey", t) ? e.classList.contains("active") ? a.removeActiveItem(e) : a.setActiveItemClass(e) : (a.clearActiveItems(), a.setActiveItemClass(e))
        ...
        setActiveItemClass(e) {
            ...
            s && J(s, "last-active"), W(e, "active last-active"), t.trigger("item_select", e), -1 == t.activeItems.indexOf(e) && t.activeItems.push(e)
        }
        ...
        setActiveOption(e, t = !0) {
            e !== this.activeOption && (this.clearActiveOption(), e && (this.activeOption = e, se(this.focus_node, {"aria-activedescendant": e.getAttribute("id")}), se(e, {"aria-selected": "true"}), W(e, "active"), t && this.scrollToOption(e)))
        }

        scrollToOption(e, t) {
            if (!e) return
            const s = this.dropdown_content, i = s.clientHeight, n = s.scrollTop || 0, o = e.offsetHeight,
        ...
        clearActiveOption() {
            this.activeOption && (J(this.activeOption, "active"), se(this.activeOption, {"aria-selected": null})), this.activeOption = null, se(this.focus_node, {"aria-activedescendant": null})
        }
        ...
        search(e) {
            ...
            return e !== i.lastQuery ? (i.lastQuery = e, /(.)\1{15,}/.test(e) && (e = ""), t = i.sifter.search(e, Object.assign(n, {score: s})), i.currentResults = t) : t = Object.assign({}, i.currentResults), i.settings.hideSelected && (t.items = t.items.filter(e => {
                let t = P(e.id)
                return !(null !== t && -1 !== i.items.indexOf(t))
            })), t
        }
        ...
        refreshOptions(e = !0) {
            ...
            for (t = 0; t < n; t++) {
                ...
                for (h.settings.hideSelected || d.classList.toggle("selected", h.items.includes(a)), o = l[h.settings.optgroupField] || "", s = 0, i = (r = Array.isArray(o) ? o : [o]) && r.length; s < i; s++) {
                    ...
                    const [i, a] = O(o, e)
                    s > 0 && (d = d.cloneNode(!0), se(d, {
                        id: l.$id + "-clone-" + s,
                        "aria-selected": null
                    }), d.classList.add("ts-cloned"), J(d, "active"), h.activeOption && h.activeOption.dataset.value == n && c && c.dataset.group === o.toString() && (v = d)), a.appendChild(d), "" != o && (u[o] = i)
                }
            }
            var _
            ...
            }), b.innerHTML = "", z(b, l), h.settings.highlight && (_ = b.querySelectorAll("span.highlight"), Array.prototype.forEach.call(_, function (e) {
                var t = e.parentNode
            ...
            if (h.loading ? S("loading") : h.settings.shouldLoad.call(h, g) ? 0 === m.items.length && S("no_results") : S("not_loading"), (a = h.canCreate(g)) && (d = S("option_create")), h.hasOptions = m.items.length > 0 || a, y) {
                if (m.items.length > 0) {
        ...
        updateOption(e, t) {
            ...
            c && (-1 !== (n = s.items.indexOf(o)) && s.items.splice(n, 1, r), i = s._render("item", t), c.classList.contains("active") && W(i, "active"), ie(c, i)), s.lastQuery = null
        }
        ...
        clearOptions(e) {
            ...
            B(this.options, (e, i) => {
                t(e, i) && (s[i] = e)
            }), this.options = this.sifter.items = s, this.lastQuery = null, this.trigger("option_clear")
        }
            ...
            j(this, t ? [] : ["change", "dropdown_close"], () => {
                ...
                if ((!r || -1 === n.items.indexOf(r) || ("single" === o && n.close(), "single" !== o && n.settings.duplicates)) && null !== r && n.options.hasOwnProperty(r) && ("single" === o && n.clear(t), "multi" !== o || !n.isFull())) {
                    if (s = n._render("item", n.options[r]), n.control.contains(s) && (s = s.cloneNode(!0)), i = n.isFull(), n.items.splice(n.caretPos, 0, r), n.insertAtCaret(s), n.isSetup) {
                        ...
                        n.settings.clearAfterSelect && n.setTextboxValue(), n.isPending || n.settings.closeAfterSelect || n.refreshOptions(n.isFocused && "single" !== o), 0 != n.settings.closeAfterSelect && n.isFull() ? n.close() : n.isPending || n.positionDropdown(), n.trigger("item_add", r, s), n.isPending || n.updateOriginalInput({silent: t})
                    }
        ...
        createItem(e = null, t = () => {
            ...
            if (e = e || i.inputValue(), !i.canCreate(e)) {
                return P(e) && this.options[e] && i.addItem(e), t(), !1
            }
            i.lock()
            var o = !1, r = e => {
            ...
            return s = "function" == typeof i.settings.create ? i.settings.create.call(this, e, r) : {
        ...
        updateOriginalInput(e = {}) {
            ...
            if (t.is_select_tag) {
                ...
                function l(e, s, i) {
                    return e || (e = K('<option value="' + V(s) + '">' + V(i) + "</option>")), e != n && t.input.append(e), o.push(e), (e != n || r > 0) && (e.selected = !0), e
                }
        ...
        open() {
            var e = this
            e.isLocked || e.isOpen || "multi" === e.settings.mode && e.isFull() || (e.isOpen = !0, se(e.focus_node, {"aria-expanded": "true"}), e.refreshState(), U(e.dropdown, {
                visibility: "hidden",
                display: "block"
            }), e.positionDropdown(), U(e.dropdown, {
                visibility: "visible",
                display: "block"
        ...
        positionDropdown() {
            if ("body" === this.settings.dropdownParent) {
                var e = this.control, t = e.getBoundingClientRect(), s = e.offsetHeight + t.top + window.scrollY,
        ...
        shouldDelete(e, t) {
            ...
            return !(!s.length || "function" == typeof this.settings.onDelete && !1 === this.settings.onDelete.call(this, s, t))
        }

        advanceSelection(e, t) {
            var s, i, n = this
            n.rtl && (e *= -1), n.inputValue().length || (R(oe, t) || R("shiftKey", t) ? (i = (s = n.getLastActive(e)) ? s.classList.contains("active") ? n.getAdjacent(s, e, "item") : s : e > 0 ? n.control_input.nextElementSibling : n.control_input.previousElementSibling) && (i.classList.contains("active") && n.removeActiveItem(s), n.setActiveItemClass(i)) : n.moveCaret(e))
        }
        ...
        render(e, t) {
            ...
            if (i = K(i), "option" === e || "option_create" === e ? t[n.settings.disabledField] ? se(i, {"aria-disabled": "true"}) : se(i, {"data-selectable": ""}) : "optgroup" === e && (s = t.group[n.settings.optgroupValueField], se(i, {"data-group": s}), t.group[n.settings.disabledField] && se(i, {"data-disabled": ""})), "option" === e || "item" === e) {
                ...
                se(i, {"data-value": s}), "item" === e ? (W(i, n.settings.itemClass), se(i, {"data-ts-item": ""})) : (W(i, n.settings.optionClass), se(i, {
                    role: "option",
                    id: t.$id
                }), t.$div = i, n.options[s] = t)
            }
            return i
        }
    ...
    return ce.define("change_listener", function () {
        ...
        var n = function (e, t) {
            t ? (e.checked = !0, i.uncheckedClassNames && e.classList.remove(...i.uncheckedClassNames), i.checkedClassNames && e.classList.add(...i.checkedClassNames)) : (e.checked = !1, i.checkedClassNames && e.classList.remove(...i.checkedClassNames), i.uncheckedClassNames && e.classList.add(...i.uncheckedClassNames))
        }, o = function (e) {
            setTimeout(() => {
        ...
        t.hook("after", "setupTemplates", () => {
            ...
            t.settings.render.option = (s, o) => {
                ...
                i.className && l.classList.add(i.className), l.addEventListener("click", function (e) {
                    q(e)
                }), l.type = "checkbox"
        ...
        e.hook("after", "setupTemplates", () => {
            ...
            e.settings.render.item = (s, o) => {
                ...
                return D(r, "mousedown", e => {
                    n || q(e), e.stopPropagation()
                }), D(r, "dragstart", e => {
                    i = r, setTimeout(() => {
                        r.classList.add("ts-dragging")
                    }, 0)
                }), D(r, "dragenter", l), D(r, "dragover", l), D(r, "dragleave", () => {
        ...
        e.hook("instead", "setCaret", t => {
            "single" !== e.settings.mode && e.control.contains(e.control_input) ? (t = Math.max(0, Math.min(e.items.length, t))) == e.caretPos || e.isPending || e.controlChildren().forEach((s, i) => {
            ...
            if (s) {
                const i = te(s)
                e.setCaret(t > 0 ? i + 1 : i), e.setActiveItem(), J(s, "last-active")
        ...
        e.settings.shouldOpen = !0, e.hook("before", "setup", () => {
            ...
            }), D(e.control_input, "blur", () => e.onBlur()), e.hook("before", "close", () => {
        ...
        var s = this
        if (t.append) {
            var i = '<a href="javascript:void(0)" class="' + t.className + '" tabindex="-1" title="' + V(t.title) + '">' + t.label + "</a>"
            s.hook("after", "setupTemplates", () => {
                var e = s.settings.render.item
                s.settings.render.item = (t, n) => {
                    var o = K(e.call(s, t, n)), r = K(i)
                    return o.appendChild(r), D(r, "mousedown", e => {
                        q(e, !0)
                    }), D(r, "click", e => {
                        s.isLocked || (q(e, !0), s.isLocked || s.shouldDelete([o], e) && (s.removeItem(o), s.refreshOptions(!1), s.inputState()))
                    }), o
                }
            })
        }
        ...
        e.setNextUrl = (e, t) => {
        ...
        }), e.hook("instead", "canLoad", s => s in r ? c(s) : t.call(e, s)), e.hook("instead", "loadCallback", (t, s) => {
            if (l) {
                if (o) {
                    const s = t[0]
            ...
            const t = e.lastValue
            var s
            c(t) ? (s = e.render("loading_more", {query: t})) && (s.setAttribute("data-selectable", ""), o = s) : t in r && !n.querySelector(".no-results") && (s = e.render("no_more_results", {query: t})), s && (W(s, e.settings.optionClass), n.append(s))
        }), e.on("initialize", () => {
