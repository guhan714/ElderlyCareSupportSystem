...
!function (e, t) {
    ...
    const je = e => {
            ...
            if (e.target === t || n && n.contains(e.target)) {
                Te = !0;
                const n = Ve(e);
                Se = n.clientX, Oe = n.clientY, Me = parseInt(t.style.insetInlineStart) || 0, He = parseInt(t.style.insetBlockStart) || 0, z(t, "swal2-dragging")
            }
        }, Ie = e => {
            const t = C();
            if (t && Te) {
                ...
                const s = n - Se;
                t.style.insetInlineStart = `${Me + (o.isRTL ? -s : s)}px`, t.style.insetBlockStart = `${He + (i - Oe)}px`
            }
        }, De = () => {
            const e = C();
            ...
            if (n && o) {
                ...
                Y(o, "padding", t.padding), t.color && (o.style.color = t.color), t.background && (o.style.background = t.background), Z(L()), Ne(o, t), t.draggable && !t.toast ? (z(o, r.draggable), (e => {
                    e.addEventListener("mousedown", je), document.body.addEventListener("mousemove", Ie), e.addEventListener("mouseup", De), e.addEventListener("touchstart", je), document.body.addEventListener("touchmove", Ie), e.addEventListener("touchend", De)
                })(o)) : (W(o, r.draggable), (e => {
                    e.removeEventListener("mousedown", je), document.body.removeEventListener("mousemove", Ie), e.removeEventListener("mouseup", De), e.removeEventListener("touchstart", je), document.body.removeEventListener("touchmove", Ie), e.removeEventListener("touchend", De)
                })(o))
            }
        }, Ne = (e, t) => {
            const n = t.showClass || {};
    ...
    const nt = () => {
        ...
        it = ot && /iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream, st = () => {
            const e = y();
            if (!e) return;
            let t;
            e.ontouchstart = e => {
            ...
            return !(!n || !o) && (!at(e) && !lt(e) && (t === n || !(te(n) || !(t instanceof HTMLElement) || ((e, t) => {
                let n = e;
                for (; n && n !== t;) {
                    if (te(n)) return !0;
                    n = n.parentElement
        ...
        }, at = e => Boolean(e.touches && e.touches.length && "stylus" === e.touches[0].touchType),
        lt = e => e.touches && e.touches.length > 1;
    let ct = null;
    const ut = e => {
        null === ct && (document.body.scrollHeight > window.innerHeight || "scroll" === e) && (ct = parseInt(window.getComputedStyle(document.body).getPropertyValue("padding-right")), document.body.style.paddingRight = `${ct + (() => {
    ...
    function dt(e, t, n, s) {
        V() ? vt(e, s) : (i(n).then(() => vt(e, s)), We(o)), ot ? (t.setAttribute("style", "display:none !important"), t.removeAttribute("class"), t.innerHTML = "") : t.remove(), D() && (null !== ct && (document.body.style.paddingRight = `${ct}px`, ct = null), (() => {
    ...
    function pt(e) {
        e = ft(e);
        const t = tt.swalPromiseResolve.get(this), n = mt(this);
    ...
    const mt = e => {
        ...
        const o = y();
        return W(o, n.showClass.backdrop), z(o, n.hideClass.backdrop), bt(e, t, n), !0
    };
    ...
    const gt = e => {
        ...
        }, ft = e => void 0 === e ? {isConfirmed: !1, isDenied: !1, isDismissed: !0} : Object.assign({
            isConfirmed: !1,
            isDenied: !1,
            isDismissed: !1
        }, e), bt = (e, t, n) => {
            var i;
            const s = y(), r = ne(t);
            "function" == typeof n.willClose && n.willClose(t), null === (i = o.eventEmitter) || void 0 === i || i.emit("willClose", t), r && s ? yt(e, t, s, Boolean(n.returnFocus), n.didClose) : s && dt(e, s, Boolean(n.returnFocus), n.didClose)
        }, yt = (e, t, n, i, s) => {
            ...
            const n = S();
            V() ? Z(A()) : Ct(t, e), X(n), t.setAttribute("data-loading", "true"), t.setAttribute("aria-busy", "true"), t.focus()
        }, Ct = (e, t) => {
            const n = O(), o = S();
            n && o && (!t && ee(P()) && (t = P()), X(n), t && (Z(t), o.setAttribute("data-button-to-replace", t.className), n.insertBefore(o, t)), z([e, n], r.loading))
        }, At = e => e.checked ? 1 : 0, Et = e => e.checked ? e.value : null,
        ...
        Bt = (e, t) => {
            ...
            const o = e => {
                "select" === t.input ? function (e, t, n) {
                    ...
                    const i = (e, t, o) => {
                        ...
                        i.value = o, q(i, t), i.selected = Pt(o, n.inputValue), e.appendChild(i)
                    };
                    t.forEach(e => {
                        const t = e[0], n = e[1];
                        if (Array.isArray(n)) {
                ...
                }(n, Lt(e), t) : "radio" === t.input && function (e, t, n) {
                    const o = K(e, r.radio);
                    if (!o) return;
                    t.forEach(e => {
                        const t = e[0], i = e[1], s = document.createElement("input"),
                            a = document.createElement("label");
                        s.type = "radio", s.name = r.radio, s.value = t, Pt(t, n.inputValue) && (s.checked = !0);
            ...
            g(t.inputOptions) || b(t.inputOptions) ? (wt(P()), f(t.inputOptions).then(t => {
                e.hideLoading(), o(t)
    ...
    const Lt = e => {
    ...
    }, Pt = (e, t) => Boolean(t) && null != t && t.toString() === e.toString(), xt = (e, t) => {
        const n = he.innerParams.get(e);
        ...
        n.inputValidator ? Tt(e, i, t) : o && !o.checkValidity() ? (e.enableButtons(), e.showValidationMessage(n.validationMessage || o.validationMessage)) : "deny" === t ? St(e, i) : Ht(e, i)
    }, Tt = (e, t, n) => {
        const o = he.innerParams.get(e);
        e.disableInput();
        Promise.resolve().then(() => f(o.inputValidator(t, o.validationMessage))).then(o => {
            e.enableButtons(), e.enableInput(), o ? e.showValidationMessage(o) : "deny" === n ? St(e, t) : Ht(e, t)
        })
    }, St = (e, t) => {
        const n = he.innerParams.get(e);
        if (n.showLoaderOnDeny && wt(T()), n.preDeny) {
            ...
            Promise.resolve().then(() => f(n.preDeny(t, n.validationMessage))).then(n => {
                !1 === n ? (e.hideLoading(), gt(e)) : e.close({isDenied: !0, value: void 0 === n ? t : n})
            }).catch(t => Mt(e, t))
        ...
        if (n.showLoaderOnConfirm && wt(), n.preConfirm) {
            ...
            Promise.resolve().then(() => f(n.preConfirm(t, n.validationMessage))).then(n => {
                ee(L()) || !1 === n ? (e.hideLoading(), gt(e)) : Ot(e, void 0 === n ? t : n)
            }).catch(t => Mt(e, t))
        } else Ot(e, t)
    };
    ...
    function jt() {
        ...
        Z(t.loader), V() ? e.icon && X(A()) : It(t), W([t.popup, t.actions], r.loading), t.popup.removeAttribute("aria-busy"), t.popup.removeAttribute("data-loading"), t.confirmButton.disabled = !1, t.denyButton.disabled = !1, t.cancelButton.disabled = !1;
        const n = he.focusedElement.get(this);
        n instanceof HTMLElement && document.activeElement === document.body && n.focus(), he.focusedElement.delete(this)
    }
    ...
    function Nt() {
        ...
        e instanceof HTMLElement && document.activeElement === document.body && e.focus(), he.focusedElement.delete(this)
    }

    function _t() {
        he.focusedElement.set(this, document.activeElement), Vt(this, ["confirmButton", "denyButton", "cancelButton"], !0)
    }
    ...
    const Wt = {
        ...
        Kt = ["allowEscapeKey", "allowOutsideClick", "background", "buttonsStyling", "cancelButtonAriaLabel", "cancelButtonColor", "cancelButtonText", "closeButtonAriaLabel", "closeButtonHtml", "color", "confirmButtonAriaLabel", "confirmButtonColor", "confirmButtonText", "currentProgressStep", "customClass", "denyButtonAriaLabel", "denyButtonColor", "denyButtonText", "didClose", "didDestroy", "draggable", "footer", "hideClass", "html", "icon", "iconColor", "iconHtml", "imageAlt", "imageHeight", "imageUrl", "imageWidth", "preConfirm", "preDeny", "progressSteps", "returnFocus", "reverseButtons", "showCancelButton", "showCloseButton", "showConfirmButton", "showDenyButton", "text", "title", "titleText", "theme", "willClose"],
        Yt = {allowEnterKey: void 0},
        Xt = ["allowOutsideClick", "allowEnterKey", "backdrop", "draggable", "focusConfirm", "focusDeny", "focusCancel", "returnFocus", "heightAuto", "keydownListenerCapture"],
        Zt = e => Object.prototype.hasOwnProperty.call(Wt, e), Jt = e => -1 !== Kt.indexOf(e), Gt = e => Yt[e],
        Qt = e => {
    ...
    function on(e) {
        ...
        const i = sn(e), s = Object.assign({}, o, i);
        nn(s), t && (t.dataset.swal2Theme = s.theme), Fe(this, s), he.innerParams.set(this, s), Object.defineProperties(this, {
            params: {
    ...
    function rn() {
        var e;
        const t = he.domCache.get(this), n = he.innerParams.get(this);
        n ? (t.popup && o.swalCloseEventFinishedCallback && (o.swalCloseEventFinishedCallback(), delete o.swalCloseEventFinishedCallback), "function" == typeof n.didDestroy && n.didDestroy(), null === (e = o.eventEmitter) || void 0 === e || e.emit("didDestroy"), an(this)) : ln(this)
    }

    const an = e => {
        ln(e), delete e.params, delete o.keydownHandler, delete o.keydownTarget, delete o.currentInstance
    }, ln = e => {
        e.isAwaitingPromise ? (cn(he, e), e.isAwaitingPromise = !0) : (cn(tt, e), cn(he, e), delete e.isAwaitingPromise, delete e.disableButtons, delete e.enableButtons, delete e.getInput, delete e.disableInput, delete e.enableInput, delete e.hideLoading, delete e.disableLoading, delete e.showValidationMessage, delete e.resetValidationMessage, delete e.close, delete e.closePopup, delete e.closeModal, delete e.closeToast, delete e.rejectPromise, delete e.update, delete e._destroy)
    }, cn = (e, t) => {
    ...
    }, pn = e => Boolean(e.showConfirmButton || e.showDenyButton || e.showCancelButton || e.showCloseButton);
    let mn = !1;
    const hn = e => {
        e.popup.onmousedown = () => {
        ...
        e.container.onmousedown = t => {
            t.target === e.container && t.preventDefault(), e.popup.onmouseup = function (t) {
                e.popup.onmouseup = () => {
                }, (t.target === e.popup || t.target instanceof HTMLElement && e.popup.contains(t.target)) && (mn = !0)
            }
        }
    }, fn = (e, t, n) => {
        t.container.onclick = o => {
            mn ? mn = !1 : o.target === t.container && h(e.allowOutsideClick) && n(ze.backdrop)
        }
    }, bn = e => e instanceof Element || (e => "object" == typeof e && null !== e && "jquery" in e)(e);
    const yn = () => {
        if (o.timeout) return (() => {
            const e = H();
            if (!e) return;
    ...
    const Cn = {};
    const An = e => {
        for (let t = e.target; t && t !== document; t = t.parentNode) for (const e in Cn) {
    ...
    var En = Object.freeze({
        ...
        argsToParams: e => {
            const t = {};
            return "object" != typeof e[0] || bn(e[0]) ? ["title", "html", "icon"].forEach((n, o) => {
                const i = e[o];
                "string" == typeof i || bn(i) ? t[n] = i : void 0 !== i && d(`Unexpected type of ${n}! Expected "string" or "Element", got ${typeof i}`)
            }) : Object.assign(t, e[0]), t
        },
        bindClickHandler: function (e = "data-swal-template") {
            Cn[e] = this, wn || (document.body.addEventListener("click", An), wn = !0)
        },
        clickCancel: () => {
            var e;
    ...
    const Bn = ["swal-title", "swal-html", "swal-footer"], $n = e => {
        const t = {};
        return Array.from(e.querySelectorAll("swal-param")).forEach(e => {
            Hn(e, ["name", "value"]);
            const n = e.getAttribute("name"), o = e.getAttribute("value");
            n && o && (t[n] = n in Wt && "boolean" == typeof Wt[n] ? "false" !== o : n in Wt && "object" == typeof Wt[n] ? JSON.parse(o) : o)
        }), t
    }, Ln = e => {
        const t = {};
        ...
        return n && (Hn(n, ["src", "width", "height", "alt"]), n.hasAttribute("src") && (t.imageUrl = n.getAttribute("src") || void 0), n.hasAttribute("width") && (t.imageWidth = n.getAttribute("width") || void 0), n.hasAttribute("height") && (t.imageHeight = n.getAttribute("height") || void 0), n.hasAttribute("alt") && (t.imageAlt = n.getAttribute("alt") || void 0)), t
    }, Tn = e => {
        ...
        const t = Bn.concat(["swal-param", "swal-function-param", "swal-button", "swal-image", "swal-icon", "swal-input", "swal-input-option"]);
        ...
        if (qn(i, s, e), setTimeout(() => {
            Dn(i, s)
        }, 10), D() && (Vn(i, void 0 !== e.scrollbarPadding && e.scrollbarPadding, r), (() => {
            const e = y();
        ...
        })()), it && !1 === e.backdrop && s.scrollHeight > i.clientHeight && (i.style.pointerEvents = "auto"), V() || o.previousActiveElement || (o.previousActiveElement = document.activeElement), "function" == typeof e.didOpen) {
            const t = e.didOpen;
            setTimeout(() => t(s))
        }
        ...
        const n = y();
        n && (t.removeEventListener("animationend", In), t.removeEventListener("transitionend", In), n.style.overflowY = "auto", W(n, r["no-transition"]))
    }, Dn = (e, t) => {
        ne(t) ? (e.style.overflowY = "hidden", t.addEventListener("animationend", In), t.addEventListener("transitionend", In)) : e.style.overflowY = "auto"
    }, Vn = (e, t, n) => {
        (() => {
            if (ot && !N(document.body, r.iosfix)) {
                const e = document.body.scrollTop;
                document.body.style.top = -1 * e + "px", z(document.body, r.iosfix), st()
            }
        })(), t && "hidden" !== n && ut(n), setTimeout(() => {
            e.scrollTop = 0
        })
    }, qn = (e, t, n) => {
        var o;
    ...
    var Nn = (e, t) => /^[a-zA-Z0-9.+_'-]+@[a-zA-Z0-9.-]+\.[a-zA-Z0-9-]+$/.test(e) ? Promise.resolve() : Promise.resolve(t || "Invalid email address"),
        _n = (e, t) => /^https?:\/\/(www\.)?[-a-zA-Z0-9@:%._+~#=]{1,256}\.[a-z]{2,63}\b([-a-zA-Z0-9@:%_+.~#?&/=]*)$/.test(e) ? Promise.resolve() : Promise.resolve(t || "Invalid URL");

    function Rn(e) {
        !function (e) {
            e.inputValidator || ("email" === e.input && (e.inputValidator = Nn), "url" === e.input && (e.inputValidator = _n))
    ...
    class zn {
        constructor(...t) {
            ...
            var i, s, r;
            this.params = o, this.isAwaitingPromise = !1, i = Un, s = this, r = this._main(Fn.params), i.set(e(i, s), r)
        }
        ...
        _main(e, t = {}) {
            ...
            const n = Kn(e, t);
            Rn(n), Object.freeze(n), o.timeout && (o.timeout.stop(), delete o.timeout), clearTimeout(o.restoreFocusTimeout);
            const i = Yn(Fn);
    ...
    const Wn = (e, t, n) => new Promise((i, s) => {
            const r = t => {
            ...
            tt.swalPromiseResolve.set(e, i), tt.swalPromiseReject.set(e, s), t.confirmButton.onclick = () => {
                ...
                (e => {
                    const t = he.innerParams.get(e);
                    e.disableButtons(), t.returnInputValueOnDeny ? xt(e, "deny") : St(e, !1)
                })(e)
                ...
                "select" === t.input || "radio" === t.input ? Bt(e, t) : ["text", "email", "number", "tel", "textarea"].some(e => e === t.input) && (g(t.inputValue) || b(t.inputValue)) && (wt(P()), $t(e, t))
            })(e, n), jn(n), Xn(o, n, r), Zn(t, n), setTimeout(() => {
            ...
            const n = (e => {
                ...
                if (!t) return {};
                const n = t.content;
                return Mn(n), Object.assign($n(n), Ln(n), Pn(n), xn(n), Tn(n), Sn(n), On(n, Bn))
            })(e), o = Object.assign({}, Wt, t, n, e);
            return o.showClass = Object.assign({}, Wt.showClass, o.showClass), o.hideClass = Object.assign({}, Wt.hideClass, o.hideClass), !1 === o.animation && (o.showClass = {backdrop: "swal2-noanimation"}, o.hideClass = {}), o
        }, Yn = e => {
            const t = {
                popup: C(),
                container: y(),
            ...
            const o = H();
            Z(o), t.timer && (e.timeout = new kn(() => {
                n("timer"), delete e.timeout
            }, t.timer), t.timerProgressBar && o && (X(o), _(o, t, "timerProgressBar"), setTimeout(() => {
                e.timeout && e.timeout.running && oe(t.timer)
            })))
        }, Zn = (e, t) => {
            if (!t.toast) return h(t.allowEnterKey) ? void (Jn(e) || Gn(e, t) || Ke(-1, 1)) : (m("allowEnterKey", "preConfirm: () => false"), void e.popup.focus())
        }, Jn = e => {
            const t = Array.from(e.popup.querySelectorAll("[autofocus]"));
            for (const e of t) if (e instanceof HTMLElement && ee(e)) return e.focus(), !0;
            return !1
        },
        Gn = (e, t) => t.focusDeny && ee(e.denyButton) ? (e.denyButton.focus(), !0) : t.focusCancel && ee(e.cancelButton) ? (e.cancelButton.focus(), !0) : !(!t.focusConfirm || !ee(e.confirmButton)) && (e.confirmButton.focus(), !0);
    zn.prototype.disableButtons = _t, zn.prototype.enableButtons = Nt, zn.prototype.getInput = Dt, zn.prototype.disableInput = Ft, zn.prototype.enableInput = Rt, zn.prototype.hideLoading = jt, zn.prototype.disableLoading = jt, zn.prototype.showValidationMessage = Ut, zn.prototype.resetValidationMessage = zt, zn.prototype.close = pt, zn.prototype.closePopup = pt, zn.prototype.closeModal = pt, zn.prototype.closeToast = pt, zn.prototype.rejectPromise = ht, zn.prototype.update = on, zn.prototype._destroy = rn, Object.assign(zn, En), Object.keys(un).forEach(e => {
        zn[e] = function (...t) {
            if (Fn && Fn[e]) return Fn[e](...t)
        }
    }), zn.DismissReason = ze, zn.version = "11.26.22";
    const Qn = zn;
