...
namespace ElderlyCareSupportSystem.Web.Modules.Company.Controllers;
...
public class CompanyController : Controller
{
    ...
    public async Task<IActionResult> Register([FromBody]CompanyViewModel company)
    {
        ...
        return Json(new { success = true, redirectionUrl = Url.Action("Login", "Authentication"), message = companyCreation.Message });
